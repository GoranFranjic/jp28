...
public class LjubavniKalkulator {
    ...
    public static void main(String[] args) {
        ...
        // Provjera ako je rezultat manji od 100
        if (Integer.parseInt(nizTri.toString()) < 100) {
     ...
     // Provjera ako je rezultat manji od 100
        ...
        System.out.println("Rezultat kranje petlje je: " + nizTri);

        unos.close(); // Zatvaranje Scanner objekta
    }
}
